...
\paragraph{}
INSERER IMAGE DE LA PREMIERE MAP !!!!!
\paragraph{}
...
\paragraph{}Suite à nos échanges, il a été convenue de créer une classe Instruction qui servira de pont entre l’interpréteur et le moteur.
...
4. Instruction (  Percepts = [],
		...
		Action = ACTION_MOVE ) }
\end{lstlisting}
Le comportement défini en listing \ref{lst:BehaviorExample}
\subparagraph{1. Négation.}
Instructions avec NOT\_.
\subparagraph{2. Mouvement tactique.}
Instructions sans actions.
\subparagraph{3. Instruction par défaut.}
Instructions sans percepts et sans actions non terminales.
\subparagraph{4. Cas exceptionnel.}
Instructions sans percepts et sans actions non terminales.
