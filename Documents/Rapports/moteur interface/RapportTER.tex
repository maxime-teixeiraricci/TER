...
public void Undo()
{
    ...
    if( cptObjects > 0 ) {
        ...
        // Si la pièce à undo supprimée est une pièce IF, on oublie pas de mettre à jour le compteur de pièces IF
        ...
        // Si la pièce à undo est inactive alors on l'active et on change sont ordre dans la liste des pièces
