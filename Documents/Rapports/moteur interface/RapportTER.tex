...
\item\textbf{Création d'unités}\newline
Lorsque l'on détermine un nombre d'unités à instancier au début de la partie, et qu'on lanc ela partie, le nombre correct est bel et bien instancié.
Ceci dit, si on quitte la partie, change de carte, et relance avec les mêmes paramètres (donc sans toucher au nombre d'unités), il arrive que le nombre d'unités créées soit incorrect.
\end{enumerate}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{MainMenuFrancais}
	\caption{Menu principal en français}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{MainMenuAnglais}
	\caption{Menu principal en anglais}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{PlainDemo}
	\caption{Menu principal en français}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{DesolateDemo}
	\caption{Menu principal en anglais}
\end{figure}

\begin{figure}[h]
	\centering
		\includegraphics[scale=1]{SimpleDemo}
	\caption{Menu principal en anglais}
\end{figure}
