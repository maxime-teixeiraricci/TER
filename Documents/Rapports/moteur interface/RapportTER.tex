...
\begin{figure}[h]
        \centering
		\includegraphics[scale=0.5]{MapSimpleImage}
	\caption{L'unité Light de WarBot.}
\end{figure}
\begin{figure}[!p]
        \centering
		\includegraphics[scale=0.5]{MapMountainImage}
	\caption{L'unité Light de WarBot.}
\end{figure}
\begin{figure}[!p]
        \centering
		\includegraphics[scale=0.5]{MapDesolateImage}
	\caption{L'unité Light de WarBot.}
\end{figure}
\begin{figure}[!p]
        \centering
		\includegraphics[scale=0.5]{MapPlainImage}
	\caption{L'unité Light de WarBot.}
\end{figure}
\begin{figure}[!p]
        \centering
...
\begin{itemize}
\item La voiture se met à fumer légèrement lorsque ses points de vie sont entre 75\% et 100\%.
\item Une fumée plus épaisse se déclenche lorsque ses points de vie sont entre 50\% et 75\%.
\item La voiture est en feu lorsque ses points de vie sont entre 25\% et 50\%.
\item Pour finir elle explose en un amas de particule lorsque ses points de vies atteignent 0.
Les GameObject concernant ces différentes animations sont présents au sein des stats de chaque unité et peuvent être modifié simplement.
\end{itemize}
\subsection{Sons.}
...
\begin{figure}[!h]
	\centering
		\includegraphics[scale=0.40]{AudioSource}
...
\begin{figure}[!h]
	\centering
		\includegraphics[scale=0.40]{RessourcesMax}
...
\begin{figure}[!h]
	\centering
		\includegraphics[scale=0.40]{ManuelJeu/ModeJeuRessourceRace}
