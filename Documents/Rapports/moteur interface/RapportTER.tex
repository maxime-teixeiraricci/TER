...
\item \textit{RessourceGenerator.} Cet objet permets
...
\item \textit{MinimapCamera.} Caméra permettant l'affichage de la mini-carte.
\item \textit{ItemManager.} gère le comportement des objets.
\item \textit{HUD.} canvas d'affichage tête haute.
\item \textit{UnitManager.} gestionnaire d'unité qui comporte les 4 équipes.
\end{itemize}
